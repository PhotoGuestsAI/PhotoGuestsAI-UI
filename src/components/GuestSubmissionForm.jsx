...
const GuestSubmissionForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error("שגיאה בשליחת הפרטים:", error);
            setErrorMessage("אירעה שגיאה בעת שליחת הפרטים.");
        }
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4" dir="rtl">
            <div className="bg-white shadow-lg rounded-lg overflow-hidden max-w-lg w-full p-6">
                <h2 className="text-3xl font-extrabold text-gray-900 text-center">רישום אורחים</h2>
                <p className="mt-2 text-gray-500 text-center">הזן את פרטיך כדי לקבל את תמונות האירוע.</p>
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                    ...
                    <div className="flex items-center bg-gray-100 border rounded-md p-3">
                        ...
                        <select
                            ...
                            className="bg-transparent border-none outline-none mr-3 text-gray-900"
                        >
